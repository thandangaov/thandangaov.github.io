...
audio.addEventListener('error',()=>{stop();status.textContent='Thiếu music.mp3';status.title='Không tìm thấy music.mp3. Hãy đặt music.mp3 cùng thư mục với index.html.';});
